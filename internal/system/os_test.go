...
func TestOsDetection(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestOsJudgment")
...
func TestOsEnvOperation(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestOsEnvOperation")
...
func TestExecCommand(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestExecCommand")
...
func TestStartProcess(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestStartProcess")
...
func TestKillProcess(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestKillProcess")
...
func TestStopProcess(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestStopProcess")
...
func TestGetProcessInfo(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestGetProcessInfo")
