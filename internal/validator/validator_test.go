...
func TestIsAllUpper(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsAllUpper")
...
func TestIsAllLower(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsAllLower")
...
func TestContainLower(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestContainLower")
...
func TestContainUpper(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestContainUpper")
...
func TestContainLetter(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestContainLetter")
...
func TestContainNumber(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestContainNumber")
...
func TestIsJSON(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsJSON")
...
func TestIsNumber(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsNumber")
...
func TestIsFloat(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsFloat")
...
func TestIsInt(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsInt")
...
func TestIsNumberStr(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsNumberStr")
...
func TestIsFloatStr(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsFloatStr")
...
func TestIsIntStr(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsIntStr")
...
func TestIsPort(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsPort")
...
func TestIsIpPort(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsIpPort")
...
func TestIsIpV4(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsIpV4")
...
func TestIsIpV6(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsIpV6")
...
func TestIsUrl(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsUrl")
...
func TestIsDns(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsDns")
...
func TestIsEmail(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsEmail")
...
func TestContainChinese(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestContainChinese")
...
func TestIsChineseMobile(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsChineseMobile")
...
func TestIsChinesePhone(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsChinesePhone")
...
func TestIsChineseIdNum(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsChineseIdNum")
...
func TestIsCreditCard(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsCreditCard")
...
func TestIsBase64(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsBase64")
...
func TestIsEmptyString(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsEmptyString")
...
func TestIsAlpha(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsAlpha")
...
func TestIsRegexMatch(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsRegexMatch")
...
func TestIsStrongPassword(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsStrongPassword")
...
func TestIsWeakPassword(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsWeakPassword")
...
func TestIsZeroValue(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsZeroValue")
...
func TestIsGBK(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsGBK")
...
func TestIsASCII(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsASCII")
...
func TestIsPrintable(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsPrintable")
...
func TestIsBin(t *testing.T) {
	t.Parallel()
	assert := general.NewAssert(t, "TestIsBin")
...
func TestIsHex(t *testing.T) {
	t.Parallel()
	assert := general.NewAssert(t, "TestIsHex")
...
func TestIsBase64URL(t *testing.T) {
	t.Parallel()
	assert := general.NewAssert(t, "TestIsBase64URL")
...
func TestIsJWT(t *testing.T) {
	t.Parallel()
	assert := general.NewAssert(t, "TestIsJWT")
...
func TestIsVisa(t *testing.T) {
	t.Parallel()
	assert := general.NewAssert(t, "TestIsVisa")
...
func TestIsMasterCard(t *testing.T) {
	t.Parallel()
	assert := general.NewAssert(t, "TestIsMasterCard")
...
func TestIsAmericanExpress(t *testing.T) {
	t.Parallel()
	assert := general.NewAssert(t, "TestIsAmericanExpress")
...
func TestIsUnionPay(t *testing.T) {
	t.Parallel()
	assert := general.NewAssert(t, "TestIsUnionPay")
...
func TestIsChinaUnionPay(t *testing.T) {
	t.Parallel()
	assert := general.NewAssert(t, "TestIsChinaUnionPay")
...
func TestIsAlphaNumeric(t *testing.T) {
	...
	assert := general.NewAssert(t, "TestIsAlphaNumeric")
